export const siteContent = {
  ...
  gallery: {
    ...
    images: [
      { src: "/images/galeria/1.webp", alt: "Koloryzacja blond" },
      { src: "/images/galeria/2.webp", alt: "Strzyżenie damskie" },
      { src: "/images/galeria/3.webp", alt: "Stylizacja okolicznościowa" },
      { src: "/images/galeria/4.webp", alt: "Pielęgnacja keratynowa" },
      { src: "/images/galeria/5.webp", alt: "Balayage" },
      { src: "/images/galeria/6.webp", alt: "Strzyżenie męskie" },
      { src: "/images/galeria/7.webp", alt: "Koloryzacja 3D" },
      { src: "/images/galeria/8.webp", alt: "Przedłużanie włosów" },
    ],
    beforeAfter: {
      title: "Przed i Po",
      items: [
